...
- ✅ `doc/TEST_README.md` - Test documentation
- ✅ `doc/TEST_SUMMARY.md` - Test summary
...
- ✅ `doc/RELEASE_INSTRUCTIONS.md` - This file

### Modified Files
- ✅ `.github/workflows/release.yml` - Added test step
- ✅ `doc/RELEASE_NOTES.md` - Added v1.1.0 notes
...
- Select tag `v1.1.0`
- Copy content from `doc/RELEASE_NOTES.md`
